...
const banner = `cookieStorage@v${version}. Jherax 2017. Visit https://github.com/jherax/cookie-storage`;
const test = /\.min.js($|\?)/i;

const config = {
  entry: {
    'cookie-storage': PATHS.source.js,
    'cookie-storage.min': PATHS.source.js,
  },
  output: {
    path: PATHS.dist.folder,
    filename: '[name].js',
    libraryTarget: 'umd',
    library: 'cookieStorage', // global var in the browser
  },
  module: {
    rules: [
      {
